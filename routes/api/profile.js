...
[
  ...
  async (req, res) => {
   ...
   const {
     company,
     website, location, bio, status, githubusername, skills, youtube, twitter, instagram, facebook, linkedin
   } = req.body;
...
const {
  school, degree, fieldofstudy, from, to, current, description, location
} = req.body;
